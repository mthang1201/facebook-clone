export default function SidePane() {
    return (
        <div className="flex flex-col ml-2 pr-2 mt-4">
            <div className="flex flex-col items-start">
                <button className="rounded-lg flex items-center h-14 w-full gap-4 hover:bg-zinc-700">
            ...
            <div className="mx-2 border-t border-zinc-600" />
            <div className="flex flex-col">
                <div className="text-zinc-300 font-bold rounded-lg flex items-center pt-3 pb-1 w-full gap-4 pl-2">
                    Your shortcuts
                </div>
                <div className="flex flex-col items-start">
                    <button className="rounded-lg flex items-center h-14 w-full gap-4 pl-2 hover:bg-zinc-700">
